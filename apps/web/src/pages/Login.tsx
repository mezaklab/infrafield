...
import { Server, Lock, Mail, ArrowRight, ShieldCheck, Eye, EyeOff, AlertCircle, Shield, Wrench } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/95 border border-slate-800 rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-slate-400 mt-1">Prefeitura Municipal — Departamento de TI &amp; Infraestrutura</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full bg-slate-950 border border-slate-800 hover:border-slate-700 focus:border-cyan-500 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-100 focus:outline-none transition-colors placeholder:text-slate-600"

    ...
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900/80 border border-purple-900/40 rounded-2xl p-5 shadow-lg">
        ...
        <button
          type="submit"
          disabled={saving}
          className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs transition-all shadow-lg shadow-purple-600/30"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Security & Access */}
        <div className="bg-slate-900/80 border border-purple-900/40 rounded-2xl p-6 shadow-xl space-y-4">
        ...
        {/* Monitoring & Alerts */}
        <div className="bg-slate-900/80 border border-cyan-900/40 rounded-2xl p-6 shadow-xl space-y-4">
